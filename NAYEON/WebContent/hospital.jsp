...
.map_wrap {position:relative;width:100%;height:560px;}
...
<div class="help-tip" style="z-index:2;">
   <p>
      현재 해당 서비스는 '서울시만' 시범 운영 중입니다. <br>
      추후 다른 지역들도 추가 예정이오니 많은 이용 부탁드립니다. <br><br>
      동물병원 정보는 1년 주기로 업데이트 됩니다. <br>
      정보가 업데이트 되었을 가능성이 있으니 자세한 정보는 해당 병원에 직접 문의해주세요.
   </p>
</div>


<!-- 검색창 -->
<form action="hospital.jsp?target=M_hospital/h_search">

<table class="Hos_table">
<tr>
<td colspan="2" width="50%">

   <select>
      <option value="서웉특별시"> 서울특별시 </option>
   </select> &nbsp; &nbsp;
...
<tr>
   <td colspan="3" style='table-layout:fixed'>
      <div class="map_wrap">
    <div id="map" style="width:820px;height:560px;position:relative;overflow:hidden;"></div>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=dfb440b94b8c06ed4c89531e4b35fabc&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
